  ...
  return (
    <header className="bg-[#131921] text-white relative">
      ...
      <nav className="hidden md:flex bg-[#232f3e] text-sm px-6 py-2 flex-wrap gap-6">
        ...
        <Link to="/mobiles" className="hover:text-[#febd69]">
          Mobiles
        </Link>
        <Link to="/electronics" className="hover:text-[#febd69]">
          Electronics
        </Link>
        <Link to="/fashion" className="hover:text-[#febd69]">
          Fashion
        </Link>
        <Link to="/home-kitchen" className="hover:text-[#febd69]">
          Home & Kitchen
        </Link>
        <Link to="/books" className="hover:text-[#febd69]">
          Books
        </Link>
        <Link to="/toys" className="hover:text-[#febd69]">
          Toys
        </Link>
      ...
      >
        ...
        <div className="flex flex-col space-y-4 p-4">
          <Link to="/" onClick={toggleMenu} className="hover:text-[#febd69]">
            Home
          </Link>
          <Link to="/mobiles" onClick={toggleMenu} className="hover:text-[#febd69]">
            Mobiles
          </Link>
          <Link to="/electronics" onClick={toggleMenu} className="hover:text-[#febd69]">
            Electronics
          </Link>
          <Link to="/fashion" onClick={toggleMenu} className="hover:text-[#febd69]">
            Fashion
          </Link>
          <Link to="/home-kitchen" onClick={toggleMenu} className="hover:text-[#febd69]">
            Home & Kitchen
          </Link>
          <Link to="/books" onClick={toggleMenu} className="hover:text-[#febd69]">
            Books
          </Link>
          <Link to="/toys" onClick={toggleMenu} className="hover:text-[#febd69]">
            Toys
          </Link>
          <Link to="/customer-service" onClick={toggleMenu} className="hover:text-[#febd69]">
            Customer Service
          </Link>
        </div>
      </div>
