...
const iotProductSchema = new mongoose.Schema({
  category: { type: String, default: "mobile" }, // Main category
  subCategory:{type:String,default:"mobile Component"},
...
module.exports = mongoose.model("mobilecategories", iotProductSchema);